...
function do_FCIQMC(ham, vec0, ET, tau, stepsize, ζ, nruns, nsteps, nwalkermax)
    ...
    for irun in 1:nruns
        ...
        for istep in 1:nsteps
            ...
            walkerlisti_nodead = walkerlisti[findall(x->x>0,walkerlisti)];
            walkersigni_nodead = walkersigni[findall(x->x>0,walkerlisti)];
...
localenergy = do_FCIQMC(ham, vec0, ET, tau, stepsize, ζ, nruns, nsteps, nwalkermax);
for it in 1:niter
